module.exports = {
  projectsData: [
    ...
    },
    {
      ...
      alt: 'UnoTown',
      roles: ['Lead Designer', 'Co-Founder'],
      contribution: ['UI Design', 'Front-end Development'],
      tools: ['Adobe XD, CSS, HTML, JavaScript'],
      colors: ['#FFB900', '#DA0037'],
      brief:
        'As a UI designer and front-end developer, I created a responsive website that showcases the best local food spots in the city. The website features beautiful imagery, detailed descriptions, and an interactive map to help foodies discover and explore new places to eat. The website is designed to be simple, easy-to-use, and visually appealing.',
      target:
      ...
      challenge:
        'Design and develop a responsive website that showcases the best local food spots in the city.',
      description:
        'Led the design efforts for a startup project focused on revolutionizing the house cleaning service industry. As the lead designer, I conceptualized and crafted a user-centric platform aimed at simplifying the process for consumers to effortlessly order cleaning services at competitive prices. By directly connecting consumers with freelance cleaners, eliminating the need for intermediaries, the platform not only enhances user experience but also disrupts the traditional service model, providing a seamless and cost-effective solution for both consumers and freelancers alike.',
      newKey: 'newValue',
    },
  ],
};
