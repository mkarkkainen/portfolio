  ...
  "projectsData": [
    {
      ...
      "target": "Our target audience is individuals who are interested in supporting various philanthropic causes and want to see the impact of their donations. The platform is designed to attract users who enjoy gaming and competition and are motivated by receiving recognition for their efforts.",
      "objectives": [
      ...
      "design": "The design of the platform should be visually engaging and consistent with the branding of the philanthropic campaigns it supports. The platform should be designed with a mobile-first approach to ensure a seamless user experience across all devices.",
      ...
      "conclusion": "Our gamified donation platform aims to encourage users to participate in philanthropic campaigns, track their impact, collect trophies, and compete against other individuals and communities. By creating a fun, interactive and rewarding user experience, we hope to increase engagement and awareness of philanthropic causes and encourage ongoing donations.",
      "challenge": "Design and build a gamified donation platform based on the existing one. Section features to be developed in phases and plan a feature runway for long-term development.",
      "description": "The Beast Philanthropy website is a donation platform designed to bring visibility and to gather support for different charitable operations around the world. The platform includes a gamified donation system to encourage user engagement and voluntary work through earning prizes and trophies aswell as leaderboards to introduce competition.",
      "newKey": "newValue"
    },
    {
      "id": 2,
      ...
      "brief": "As a UI designer and front-end developer, I created a responsive website that showcases the best local food spots in the city. The website features beautiful imagery, detailed descriptions, and an interactive map to help foodies discover and explore new places to eat. The website is designed to be simple, easy-to-use, and visually appealing.",
      "target": "The target audience is foodies who are looking for new and exciting places to eat in the city. The website is designed to attract individuals who appreciate good food, unique experiences, and quality aesthetics.",
      "objectives": [
      ...
      "design": "The design of the website should be clean, modern, and visually appealing, with a focus on showcasing the food and atmosphere of each restaurant. The website should be designed with a mobile-first approach to ensure a seamless user experience across all devices.",
      ...
      "conclusion": "Foodie Finds is a responsive website designed to help foodies discover and explore new places to eat in the city. By creating a visually appealing and user-friendly experience, we hope to increase awareness of local food businesses and support the local economy.",
      "challenge": "Design and develop a responsive website that showcases the best local food spots in the city.",
      "description": "Foodie Finds is a website designed to help foodies discover and explore new places to eat in the city. The website features beautiful imagery, detailed descriptions, and an interactive map to make the process of finding new and exciting places to eat easier and more enjoyable.",
      "newKey": "newValue"
    },
    {
      "id": 3,
